...
- **Crash al arrancar en v0.0.12** — `app.setDesktopFileName()` no existe en la versión de Electron bundleada. Eliminado; el flag `--class` cubre el caso X11/XWayland que es el origen del problema.
