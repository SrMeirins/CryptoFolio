...
export const OP_META: Record<string, OpMeta> = {
  ...
  DEPOSIT_FIAT:      { label: 'Depósito EUR',   color: '#6366f1', group: 'other',    rowBg: 'rgba(99,102,241,0.04)'  },
  DEPOSIT_CRYPTO:    { label: 'Depósito cripto',color: '#8b5cf6', group: 'other',    rowBg: 'rgba(139,92,246,0.04)'  },
  ...
  STAKING_REWARD:    { label: 'Staking',       color: '#f59e0b', group: 'income',   rowBg: 'rgba(245,158,11,0.05)'  },
  MINING_REWARD:     { label: 'Mining',        color: '#f59e0b', group: 'income',   rowBg: 'rgba(245,158,11,0.05)'  },
  LENDING_INTEREST:        { label: 'Lending',         color: '#f59e0b', group: 'income', rowBg: 'rgba(245,158,11,0.05)' },
  LENDING_INTEREST_LOCKED: { label: 'Lending Locked',  color: '#d97706', group: 'income', rowBg: 'rgba(217,119,6,0.06)'  },
  CASHBACK:          { label: 'Cashback',      color: '#f59e0b', group: 'income',   rowBg: 'rgba(245,158,11,0.05)'  },
  AIRDROP:           { label: 'Airdrop',       color: '#f59e0b', group: 'income',   rowBg: 'rgba(245,158,11,0.05)'  },
  FORK:              { label: 'Fork',          color: '#f59e0b', group: 'income',   rowBg: 'rgba(245,158,11,0.05)'  },
  TRANSFER_INTERNAL: { label: 'Transferencia', color: '#6b7280', group: 'transfer', rowBg: 'transparent'            },
  STAKING_LOCK:      { label: 'Staking lock',      color: '#f59e0b', group: 'transfer', rowBg: 'rgba(245,158,11,0.04)'  },
  STAKING_UNLOCK:    { label: 'Staking unlock',    color: '#10b981', group: 'transfer', rowBg: 'rgba(16,185,129,0.04)'  },
  LAUNCHPOOL_LOCK:   { label: 'Launchpool lock',   color: '#8b5cf6', group: 'transfer', rowBg: 'rgba(139,92,246,0.04)'  },
  LAUNCHPOOL_UNLOCK: { label: 'Launchpool unlock', color: '#10b981', group: 'transfer', rowBg: 'rgba(16,185,129,0.04)'  },
